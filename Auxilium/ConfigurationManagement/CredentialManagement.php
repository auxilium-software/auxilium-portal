...
namespace Auxilium\ConfigurationManagement;
...
class CredentialManagement
{
    ...
    public function __construct(bool $newInstance = false, array $newVariables = [])
    {
        ...
        if($newInstance)
        {
            ...
            $localOnlyApiKey = base64_encode(SecurityUtilities::GeneratePseudoRandomBytes(length: 24));
            $urlMetadataJwtSecret = base64_encode(SecurityUtilities::GeneratePseudoRandomBytes(length: 48));
