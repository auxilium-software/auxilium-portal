...
class InitUtilities
{
    ...
    public static function HandleSetupKey(): string
    {
        ...
        if($setup_key === null)
        {
            $setup_key = rtrim(strtr(base64_encode(SecurityUtilities::GeneratePseudoRandomBytes(length: 64)), '+/', '-_'), '=');
    ...
    public static function CreateRootAccount(array $variables): void
    {
        ...
        // $language_prop = GraphDatabaseConnection::new_node(strtoupper(PageBuilder::GetVariable(variableName: 'selected_lang')), "text/plain", null, $user_node);
